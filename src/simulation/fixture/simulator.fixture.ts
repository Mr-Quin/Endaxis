...
export const simulatorFixture2: LegacySimulatorFixture = {
  actionNode: [
    {
      trackId: "ENDMINISTRATOR",
      trackIndex: 0,
      node: {
        ...
        duration: 0.8,
        cooldown: 0,
        icon: "/avatars/ENDMINISTRATOR/icon_skill_endmin_01.webp",
        spCost: 100,
        gaugeCost: 0,
        gaugeGain: 6.5,
        teamGaugeGain: 6.5,
    ...
    },
    {
      ...
      node: {
        ...
        physicalAnomaly: [],
        weaponId: null,
        instanceId: "inst_61z27xw",
        sourceWeaponId: null,
        logicalStartTime: 0.8,
        startTime: 0.8,
      },
      type: "action",
      id: "inst_61z27xw",
    },
    {
      ...
      node: {
        ...
        duration: 1.7,
        cooldown: 10,
        icon: "/avatars/LAEVATAIN/icon_combo_skill_laevat_01.webp",
        spCost: 0,
        gaugeCost: 0,
        gaugeGain: 30,
        teamGaugeGain: 0,
        ...
        allowedTypes: ["magma_1", "magma_2", "magma_3", "magma_4", "magma_0"],
        physicalAnomaly: [
          [
            {
              type: "magma_1",
    ...
    },
    {
      ...
      node: {
        ...
        duration: 1,
        cooldown: 0,
        icon: "/avatars/LAEVATAIN/icon_skill_laevat_01_line.webp",
        spCost: 100,
        gaugeCost: 0,
        gaugeGain: 0,
        teamGaugeGain: 0,
